...
- **[Complete API Documentation](README.md)** - Detailed API reference with examples
- **[HTTP Cookie Auth Guide](HTTP_COOKIE_AUTH.md)** - Secure cookie-based authentication
- **[Module B6 Summary](MODULE_B6_SUMMARY.md)** - Dashboard implementation details
- **[Quick Start Guide](QUICK_START_B6.md)** - Frontend integration examples
